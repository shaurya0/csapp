 ...
 *   Rating: 3
 */
int32_t logicalShift(int32_t x, int32_t n) {
  return 2;
}
/*
 ...
 *   Rating: 2
 */
int32_t fitsBits(int32_t x, int32_t n) {
  return 2;
}
/*
